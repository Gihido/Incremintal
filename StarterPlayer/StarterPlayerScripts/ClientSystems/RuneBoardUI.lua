...
function RuneBoardUI.Init(context)
	...
	local rollBoard = createBoard(context, context.BoardPartNames.RuneRoll, "RuneRollBoardSurfaceGui", "RUNE ROLL", Color3.fromRGB(166, 255, 115))
	local indexBoard = createBoard(context, context.BoardPartNames.RuneIndex, "RuneIndexBoardSurfaceGui", "RUNE INDEX", Color3.fromRGB(132, 223, 255))
	local statsBoard = createBoard(context, context.BoardPartNames.RuneStatsIndex, "RuneStatsBoardSurfaceGui", "RUNE STATS", Color3.fromRGB(255, 228, 132))
