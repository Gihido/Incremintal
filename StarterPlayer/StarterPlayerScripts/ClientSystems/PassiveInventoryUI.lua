...
function PassiveInventoryUI.Init(context)
	...
	local rollBoard = createBoard(context, "PassiveRollBlock", "PassiveRollBoardSurfaceGui", "PASSIVE ROLL", Color3.fromRGB(213, 184, 255))
	local inventoryBoard = createBoard(context, "PassiveInventoryBlock", "PassiveInventoryBoardSurfaceGui", "PASSIVE INVENTORY", Color3.fromRGB(176, 232, 255))
